...
var numPositions = 36; // Number of positions for the cube
var positions = [];
var colors = [];
...
var axis = 0;
var theta = [0, 0, 0];
var rotate = true; // Flag to control rotation
...
function init() {
    ...
    colorCube();  // Initialize the cube colors and vertices
    addAxes();    // Initialize the axes
...
function render() {
    ...
    if (rotate) {
        theta[axis] += 2.0; // Only rotate if 'rotate' is true
    }
